...
const defaultState = {
    ...
    bins: [
        { id: 0, name: "Recyclable", type: "recyclable", weight: 0, volume: 0, itemsCount: 0, isSimulated: true, health: { battery: 100, signal: 98, motor: 100, sensor: 100, clean: 100 } },
        { id: 1, name: "Wet Waste", type: "wet", weight: 0, volume: 0, itemsCount: 0, isSimulated: true, health: { battery: 95, signal: 96, motor: 98, sensor: 99, clean: 95 } },
        { id: 2, name: "Hazardous", type: "hazardous", weight: 0, volume: 0, itemsCount: 0, isSimulated: true, health: { battery: 100, signal: 99, motor: 100, sensor: 100, clean: 100 } },
        { id: 3, name: "Dry Waste", type: "dry", weight: 0, volume: 0, itemsCount: 0, isSimulated: true, health: { battery: 88, signal: 92, motor: 95, sensor: 97, clean: 80 } }
    ]
};
...
const defaultHistory = {
    logs: [],
    sessions: [],
    timeSeriesLog: [] // Category trends data { timestamp, recyclable, wet, hazardous, dry }
};
