...
const defaultState = {
    ...
    bins: [
        { id: 0, name: "Dry Waste", type: "dry", weight: 0, volume: 0, itemsCount: 0, isSimulated: true, health: { battery: 88, signal: 92, motor: 95, sensor: 97, clean: 80 } },
        ...
        { id: 3, name: "Recyclable", type: "recyclable", weight: 0, volume: 0, itemsCount: 0, isSimulated: true, health: { battery: 100, signal: 98, motor: 100, sensor: 100, clean: 100 } }
    ]
};
